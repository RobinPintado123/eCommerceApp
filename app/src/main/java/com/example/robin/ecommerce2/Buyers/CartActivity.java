...
import com.example.robin.ecommerce2.Model.Cart;
import com.example.robin.ecommerce2.Prevalent.Prevalent;
import com.example.robin.ecommerce2.R;
import com.example.robin.ecommerce2.ViewHolder.CartViewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //valueOf converts the integer into String
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                ...
                //txtTotalAmount.setText(" " + model.getPrices());
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(shippingState.equals("shipped")){
                        ...
                        txtMsg1.setText("Congratulations, your final order has been placed succseffully. Soon it will be verified");
